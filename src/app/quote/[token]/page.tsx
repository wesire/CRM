...
const PLACEHOLDER_QUOTE: Quote = {
  ...
  updatedAt: new Date(),
  lineItems: [
    { id: 'li1', quoteId: '2', description: 'Labour — 4 hours @ £65/hr', quantity: 4, unitPrice: 65, total: 260, optional: false, sortOrder: 0, createdAt: new Date(), updatedAt: new Date() },
    { id: 'li2', quoteId: '2', description: 'Replacement stop tap (15mm)', quantity: 1, unitPrice: 28, total: 28, optional: false, sortOrder: 1, createdAt: new Date(), updatedAt: new Date() },
    { id: 'li3', quoteId: '2', description: 'Flexi hose set (pair)', quantity: 2, unitPrice: 12, total: 24, optional: false, sortOrder: 2, createdAt: new Date(), updatedAt: new Date() },
    { id: 'li4', quoteId: '2', description: 'Waste pipe repair kit', quantity: 1, unitPrice: 18.67, total: 18.67, optional: false, sortOrder: 3, createdAt: new Date(), updatedAt: new Date() },
    { id: 'li5', quoteId: '2', description: 'Materials & consumables', quantity: 1, unitPrice: 15, total: 15, optional: false, sortOrder: 4, createdAt: new Date(), updatedAt: new Date() },
    { id: 'li6', quoteId: '2', description: 'Inline water filter upgrade (optional extra)', quantity: 1, unitPrice: 221, total: 221, optional: true, sortOrder: 5, createdAt: new Date(), updatedAt: new Date() },
  ],
}
